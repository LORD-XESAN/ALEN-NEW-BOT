...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "26 tarikh") || (event.body.toLowerCase() == "২৬ তারিখ")) {
     return api.sendMessage("২৬ তারিখ.. এই বিশেষ দিনে শুধু আমার বস 𝐀𝐋𝐄𝐍 :) 3:) নয় বরং সকল hsc আকাইম্মা দের কুরবানি.. অর্থাৎ সকলে রেডি থাকবেন..! 🤣🤝", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "jisan") || (event.body.toLowerCase() == "zisan") || (event.body.toLowerCase() == "Alen") || (event.body.toLowerCase() == "জিসান")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑: 𝐀𝐋𝐄𝐍 :) 3:) ☜.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://m.me/ALEN.OKH", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator: 𝐀𝐋𝐄𝐍 :) 3:) ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami alen") || (event.body.toLowerCase() == "cup sala ami jesan") || (event.body.toLowerCase() == "madari")) {
  ...
  if ((event.body.toLowerCase() == "nupur") || (event.body.toLowerCase() == "Nupur")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 𝐀𝐋𝐄𝐍 :) 3:) এর বোনের এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@ta n ia") || (event.body.toLowerCase() == "@TA N IA")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস 𝐀𝐋𝐄𝐍 :) 3:) এর বউ এর আইডি..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@ᎪᎡᏫᎻᏆ⎞▁▁╱╱╱💚 👿 🥺") || (event.body.toLowerCase() == "@ARU MALLIK")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস 𝐀𝐋𝐄𝐍 :) 3:) এর বউ এর আইডি😠🥰⛏️", threadID);
   };

   if ((event.body.toLowerCase() == "@প্রেয় শী") || (event.body.toLowerCase() == "@অপ্স রা")) {
     return api.sendMessage("️খবরদার এই আইডি মেনশন দিবেন না এটা আমার বস 𝐀𝐋𝐄𝐍 :) 3:) এর বউ এর আইডি🤭", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS ➠𝗔𝗟𝗘𝗡🫧", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Jerin") || (event.body.toLowerCase() == "jerin")) {
     return api.sendMessage("️এত জেরিন জেরিন না করে জেরিনের জন্য টাকলা আর পেট মোটা দেখে একটা ভাতার খুজে আন🤣", threadID);
   };

   if ((event.body.toLowerCase() == "arohi") || (event.body.toLowerCase() == "aru")) {
     return api.sendMessage("️খবরদার এই নাম নিবি না , এটা আমার বসের একমাত্র বউয়ের নাম😗🫶", threadID);
   };

   if ((event.body.toLowerCase() == "dhon") || (event.body.toLowerCase() == "Dhon")) {
     return api.sendMessage("️এত ধোন ধোন করস কেনো দেখা যাবে বাসর-রাতে-তুই-কতো পারিস..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে 𝐀𝐋𝐄𝐍 :) 3:) বসের ইনবক্সে চলে যা পাগল ছাগল🌚🐸 Link : https://m.me/ALEN.OKH", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("ভালোবাসা বলতে কিছু নাই সব ভন্ডামি 🙂👍 ভন্ডামি করার ইচ্ছা থাকলে আমার বস 𝐀𝐋𝐄𝐍 :) 3:) রে মেসেজ দিন , নীচে লিংক দেওয়া আছে https://m.me/ALEN.OKH", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Rabu") || (event.body.toLowerCase() == "rabu")) {
     return api.sendMessage("এত 𝗥𝗮𝗯𝘂 𝗥𝗮𝗯𝘂 করস কেন রাবু এখন আমার বস 𝐀𝐋𝐄𝐍 :) 3:) এর সাথে বিজি আছে , তোর জামাই/বউ থাকলে তুই চুমা নাইলে তুই ঘুমা🥴 ", threadID);
   };

   if ((event.body.toLowerCase() == "Ami jesan") || (event.body.toLowerCase() == "Ami Jesan")) {

...
module.exports.handleEvent = async function ({ api, event, Users }) {
 ...
 if (
 raw.startsWith("baby ") || raw.startsWith("Darling ") || raw.startsWith("bby ") ||
 raw.startsWith("jan ") || raw.startsWith("xan ") ||
 raw.startsWith("জান ") || raw.startsWith("darling ") || raw.startsWith("বেবি ")
 ) {
 const query = raw
 .replace(/^baby\s+|^Darling\s+|^bby\s+|^jan\s+|^xan\s+|^জান\s+|^darling\s+|^বেবি\s+/i, "")
 .trim();
 if (!query) return;
